// lab5OOP.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    Number n4 = Number ("12345", 10); // n4 will be in base 10
    n1 = Number ("255", 10); // n1 will be 11111111 (value 255 from base 10 in base 2)
    n4 += n1;
    n4.Print();

    n4 = Number("13579", 10); // n4 mentains its base (10) and will be 13579
    n4.Print();
